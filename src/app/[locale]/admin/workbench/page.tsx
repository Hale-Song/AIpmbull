...
const initialPhases: TaskPhase[] = [
  ...
  },
  {
    ...
    color: "blue",
    tasks: [
      { id: "p2-1", titleZh: "作品集列表页 + 项目统一模板：背景→痛点→选型→流程&原型→评估指标→Badcase→复盘", titleEn: "Portfolio list page + unified case template (background → metrics → badcases → recap)", done: false },
      { id: "p2-2", titleZh: "项目案例 1：RAG 知识库产品（脱敏模拟数据）", titleEn: "Case 1: RAG knowledge-base product (anonymized mock data)", done: false },
      { id: "p2-3", titleZh: "项目案例 2：Agent 智能助手", titleEn: "Case 2: Agent assistant", done: false },
      { id: "p2-4", titleZh: "项目案例 3：AI 内容生成 / AI 数据分析", titleEn: "Case 3: AI content generation / data analysis", done: false },
      { id: "p2-5", titleZh: "首页放置 3 个精选项目卡片跳转入口", titleEn: "Homepage: 3 featured project cards linking to portfolio", done: false },
      { id: "p2-6", titleZh: "资源模板下载页：AI-PRD/RAG 评估表/AI 产品画布/需求拆解", titleEn: "Resources page: AI-PRD, RAG eval sheet, AI canvas, requirement breakdown templates", done: false },
      { id: "p2-7", titleZh: "关于我页面：职业经历/擅长领域/理念/简历预览 + PDF 下载/社交账号", titleEn: "About page: career, expertise, resume preview + PDF download, socials", done: false },
      { id: "p2-8", titleZh: "联系页面：邮箱/社交账号/留言表单", titleEn: "Contact page: email, socials, optional message form", done: false },
      { id: "p2-9", titleZh: "隐私声明页面", titleEn: "Privacy policy page", done: false },
    ],
  },
  {
    id: "phase-p3",
    ...
    color: "cyan",
    tasks: [
      { id: "p3-1", titleZh: "嵌入可运行 Demo：Prompt 调试工具/简易模型评测小工具", titleEn: "Embed runnable demos: prompt debugger, mini model-eval tool", done: false },
      { id: "p3-2", titleZh: "读书笔记 & 学习日志栏目", titleEn: "Reading notes & learning log section", done: false },
      { id: "p3-3", titleZh: "PPT 分享页面", titleEn: "PPT sharing page", done: false },
      { id: "p3-4", titleZh: "友链板块", titleEn: "Friend-links section", done: false },
      { id: "p3-5", titleZh: "问答专区：读者提问收集与回复", titleEn: "Q&A section: collect and answer reader questions", done: false },
    ],
  },
  {
    id: "phase-accept",
    ...
    color: "emerald",
    tasks: [
      { id: "ac-1", titleZh: "首页 3 秒看懂：你是谁/擅长方向/可查看内容", titleEn: "Homepage passes 3-second clarity check (who / focus / content)", done: false },
      { id: "ac-2", titleZh: "作品集含 AI PM 核心要素：技术选型/量化指标/Badcase/方案权衡", titleEn: "Portfolio covers AI-PM elements: tech choices, metrics, badcases, trade-offs", done: false },
      { id: "ac-3", titleZh: "全部文章带标签，支持标签筛选", titleEn: "All articles tagged with working tag filter", done: false },
      { id: "ac-4", titleZh: "网站具备可下载 AI-PM 实战模板", titleEn: "Downloadable AI-PM templates available on site", done: false },
      { id: "ac-5", titleZh: "导航全部链接正常跳转，页脚信息完整", titleEn: "All nav links work and footer is complete", done: false },
      { id: "ac-6", titleZh: "每个页面配置独立 SEO 标题与描述", titleEn: "Every page has unique SEO title & description", done: false },
    ],
  },
];
