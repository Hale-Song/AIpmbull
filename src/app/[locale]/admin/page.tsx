...
const t: Record<string, Record<string, string>> = {
  ...
  newPortfolio: { zh: "新建作品", en: "New Project" },
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900 p-6">
          ...
          <div className="space-y-2">
            ...
            <Link href={`/${locale}/admin/portfolio`} className="flex items-center gap-3 rounded-lg bg-slate-800/50 px-4 py-3 text-sm text-slate-300 hover:bg-slate-800 hover:text-white transition-colors">
